...
<ul id=overlayMenu>
<li><p onclick="overlayon('hsla(80, 90%, 40%, 0.5)')">Green Overlay</p>
<li><p onclick="overlayon('hsla(300,100%,50%, 0.3)')">Pink Overlay</p>
<li><p onclick="underlayon('hsla(80, 90%, 40%, 0.4)')">Green Background</p>
<li><p onclick="underlayon('hsla(300,100%,50%, 0.2)')">Pink Background</p>
</ul>
